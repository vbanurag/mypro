...
class helping_hand(models.Model):
	...
	descrption=models.CharField(max_length=500, null=False, blank=False)
...
class all_project(models.Model):
	project_title=models.CharField(max_length=20, null=False, blank=False)
	project_class=models.CharField(max_length=20, null=False, blank=False)
	project_desc=models.CharField(max_length=200, null=False, blank=False)
